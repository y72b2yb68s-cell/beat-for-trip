export interface StorageProvider {
  /** Save a publicly-servable file (cover art or preview audio) and return its public URL. */
  savePublicFile(folder: "covers" | "previews", filename: string, data: Buffer): Promise<string>;
